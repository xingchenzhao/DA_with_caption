...
from model.discriminator.distance import mmd_rbf_noaccelerate, CORAL_loss
import math
from model.caption_modules.utils import clip_gradient
        ...
        for step in range(iters_per_epoch):
            ...
            if args.caption_for_da:
                ...
                tgt_cap_pred = torch.cat([tgt_cap_h_pred, tgt_cap_c_pred],
                                         dim=2)
                cap_dann_pred = dann(cap_pred)
                tgt_cap_dann_pred = dann(tgt_cap_pred)
