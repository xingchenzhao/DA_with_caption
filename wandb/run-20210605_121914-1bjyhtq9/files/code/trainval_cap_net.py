    ...
    for epoch in range(args.start_epoch, args.max_epochs + 1):
        ...
        for step in range(iters_per_epoch):
            ...
            if args.caption_for_da:
                ...
                dann_suppression = 1  #TODO: change this
            ...
            if args.caption_for_da:
                ...
                _, _, _, cap_h_pred, cap_c_pred = lstm.greedy_search(base_feat)
                _, _, _, tgt_cap_h_pred, tgt_cap_c_pred = lstm.greedy_search(
                    tgt_base_feat)
                ...
                cap_dann_pred = dann(
                    cap_pred, use_grad_reverse=False)  #TODO: change this
                tgt_cap_dann_pred = dann(
                    tgt_cap_pred, use_grad_reverse=False)  #TODO: change this
