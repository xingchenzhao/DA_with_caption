...
if __name__ == '__main__':
    ...
    elif args.dataset == "coco_train_val":
    ...
    imdb, roidb, ratio_list, ratio_index, _ = combined_roidb(
        args.imdbval_name, False)
    imdb.competition_mode(on=True)

    print('{:d} roidb entries'.format(len(roidb)))

    input_dir = args.load_dir + "/" + args.net + "/" + args.input_model
