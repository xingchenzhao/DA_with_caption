...
class cityscape_multi(imdb):
    ...
    def image_path_from_index(self, index):
        ...
        image_path = os.path.join(self._data_path, 'img', self._image_set,
                                  index_split,
                                  index + '_leftImg8bit' + self._image_ext)
    ...
    def _load_image_set_index(self):
        ...
        image_set_file = os.path.join(self._data_path, 'img_list',
                                      self._image_set + '.txt')
    ...
    def _do_python_eval(self, output_dir='output', epoch=10):
        annopath = os.path.join(self._data_path, 'anno', self._image_set+"_multi",
                                '{:s}.xml')
        imagesetfile = os.path.join(self._data_path, 'img_list',
                                    self._image_set + '.txt')
